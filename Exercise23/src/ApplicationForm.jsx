        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className={`mt-1 block w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 ${
                errors.fullName ? 'border-red-300 ring-red-500' : 'border-zinc-300 ring-blue-500'
              }`}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`mt-1 block w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 ${
                errors.email ? 'border-red-300 ring-red-500' : 'border-zinc-300 ring-blue-500'
              }`}
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`mt-1 block w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 ${
                errors.role ? 'border-red-300 ring-red-500' : 'border-zinc-300 ring-blue-500'
              }`}
            >
          ...
          <div>
            ...
            <input
              ...
              max="50"
              className={`mt-1 block w-full rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 ${
                errors.experience ? 'border-red-300 ring-red-500' : 'border-zinc-300 ring-blue-500'
              }`}
            />
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-2">Skills</label>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="h-4 w-4 rounded border-zinc-300 text-blue-600 focus:ring-blue-500"
            />
            <label className="text-sm text-zinc-700">I agree to the terms and conditions</label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              className="h-4 w-4 rounded border-zinc-300 text-blue-600 focus:ring-blue-500"
            />
            <label className="text-sm text-zinc-700">Receive notifications about new opportunities</label>
          </div>
